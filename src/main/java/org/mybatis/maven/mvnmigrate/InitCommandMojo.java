...
/**
 * Goal which executes the ibatis migration init command.
 *
...
public class InitCommandMojo extends AbstractCommandMojo<InitializeCommand> {
    ...
    /**
     * Creates a new instance of init mojo command.
     */
    public InitCommandMojo() {
    }
     ...
     */
    @Override
    InitializeCommand createCommandClass() {
